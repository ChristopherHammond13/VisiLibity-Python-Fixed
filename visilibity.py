...
class polylineList(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, polylineList, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, polylineList, name)
    __repr__ = _swig_repr
    def iterator(self): return _visilibity.polylineList_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _visilibity.polylineList___nonzero__(self)
    def __bool__(self): return _visilibity.polylineList___bool__(self)
    def __len__(self): return _visilibity.polylineList___len__(self)
    def pop(self): return _visilibity.polylineList_pop(self)
    def __getslice__(self, *args): return _visilibity.polylineList___getslice__(self, *args)
    def __setslice__(self, *args): return _visilibity.polylineList___setslice__(self, *args)
    def __delslice__(self, *args): return _visilibity.polylineList___delslice__(self, *args)
    def __delitem__(self, *args): return _visilibity.polylineList___delitem__(self, *args)
    def __getitem__(self, *args): return _visilibity.polylineList___getitem__(self, *args)
    def __setitem__(self, *args): return _visilibity.polylineList___setitem__(self, *args)
    def append(self, *args): return _visilibity.polylineList_append(self, *args)
    def empty(self): return _visilibity.polylineList_empty(self)
    def size(self): return _visilibity.polylineList_size(self)
    def clear(self): return _visilibity.polylineList_clear(self)
    def swap(self, *args): return _visilibity.polylineList_swap(self, *args)
    def get_allocator(self): return _visilibity.polylineList_get_allocator(self)
    def begin(self): return _visilibity.polylineList_begin(self)
    def end(self): return _visilibity.polylineList_end(self)
    def rbegin(self): return _visilibity.polylineList_rbegin(self)
    def rend(self): return _visilibity.polylineList_rend(self)
    def pop_back(self): return _visilibity.polylineList_pop_back(self)
    def erase(self, *args): return _visilibity.polylineList_erase(self, *args)
    def __init__(self, *args): 
        this = _visilibity.new_polylineList(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _visilibity.polylineList_push_back(self, *args)
    def front(self): return _visilibity.polylineList_front(self)
    def back(self): return _visilibity.polylineList_back(self)
    def assign(self, *args): return _visilibity.polylineList_assign(self, *args)
    def resize(self, *args): return _visilibity.polylineList_resize(self, *args)
    def insert(self, *args): return _visilibity.polylineList_insert(self, *args)
    def reserve(self, *args): return _visilibity.polylineList_reserve(self, *args)
    def capacity(self): return _visilibity.polylineList_capacity(self)
    __swig_destroy__ = _visilibity.delete_polylineList
    __del__ = lambda self : None;
polylineList_swigregister = _visilibity.polylineList_swigregister
polylineList_swigregister(polylineList)
...
class Polyline(_object):
    ...
    def getVertex(self, *args): return _visilibity.Polyline_getVertex(self, *args)
